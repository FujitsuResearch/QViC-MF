...
from qvic.model.language_model.modeling_qwen2 import Qwen2Model, Qwen2ForCausalLM
...
class LlavaQwenForCausalLM(LlavaMetaForCausalLM, Qwen2ForCausalLM):
    config_class = LlavaQwenConfig
    ...
    def forward(
        ...
        if (inputs_embeds is None) and (input_ids_q is not None):  # training
            ...
            (input_ids, position_ids, attention_mask, past_key_values, inputs_embeds, labels) \
                = self.prepare_inputs_labels_for_qvic(
                    input_ids, attention_mask, position_ids, past_key_values, labels, images, image_sizes, modalities, input_ids_q)
    ...
    def generate(
        ...
        images: Optional[torch.Tensor] = None,  # [B, T, Np, C, H, W]
